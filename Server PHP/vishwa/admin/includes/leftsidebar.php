  ...
  <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="articals_kanada.php">Articals(Kanada Language)</a></li>
                                    <li><a href="upanasyas.php">Upanasyas</a></li>
                                     <li><a href="upanasyas_kanada.php">Upanasyas(Kanada Language)</a></li>
                                     <li><a href="prashnauttaras.php">Prashnauttaras</a></li>
                                     <li><a href="prashnauttaras_Kanada.php">Prashnauttaras(Kanada Language)</a></li>
                                </ul>
                            </li>  
   ...
   <li class="has_sub">
                    ...
                    <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span> <br/> sunilkulkarni139@gmail.com</p>
                    </div>
